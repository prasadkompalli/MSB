...
#su -c "sudo cd /opt/java8_MSB/jdk8_MSB/"


#su -c "sudo alternatives --install /usr/bin/java java /usr/java/jdk1.8.0_102/bin/java 2"
#su -c "sudo alternatives --install /usr/bin/jar jar /usr/java/jdk1.8.0_102/bin/jar 2"
#su -c "sudo alternatives --install /usr/bin/javac javac /usr/java/jdk1.8.0_102/bin/javac 2"
#su -c "sudo alternatives --set jar /usr/java/jdk1.8.0_102/bin/jar"
#su -c "sudo alternatives --set javac /usr/java/jdk1.8.0_102/bin/javac"
...
#export PATH=$PATH:./usr/local/jdk1.8.0_102/bin:/usr/local/jdk1.8.0_102/jre:$HOME/bin
#export CLASSPATH=/usr/local/jdk1.8.0_102/lib
...
#su -c "sudo echo 'export JAVA_HOME=/usr/java/jdk1.8.0_102'  >> /etc/profile"
#su -c "sudo echo 'export JRE_HOME=/usr/java/jdk1.8.0_102/jre' >> /etc/profile"
#su -c "sudo echo 'export PATH=$PATH:/usr/java/jdk1.8.0_102/bin:./usr/java/jdk1.8.0_102/jre:/usr/apache/apache-tomcat-8.5.4/bin:$HOME/bin'  >> /etc/profile"
#su -c "sudo echo 'export CATALINA_HOME=/usr/apache/apache-tomcat-8.5.4'  >> /etc/profile"
...
#su -c "sudo chmod -R 775 /balu/tomcat/apache-tomcat-8.5.4/conf/*.xml"
#su -c "sudo chmod +x /balu/tomcat/apache-tomcat-8.5.4//lib/"
...
#su -c "echo 'export CLASSPATH=$CLASSPATH:./apache/softwares/apache8/apache-tomcat-8.5.4/lib'  >> ./apache/softwares/apache8/apache-tomcat-8.5.4/bin/setclasspath.sh"
su -c "echo 'export CATALINA_HOME=./apache/softwares/apache8/apache-tomcat-8.5.4'  >> /.bash_profile"
#su -c "echo 'export CATALINA_BASE=./apache/softwares/apache8/apache-tomcat-8.5.4/webapps' >> /.bash_profile"
...
#su -c "sed 's/port=\"8080\"/port=\"1122\"/g' /balu/tomcat/apache-tomcat-8.5.4/conf/server.xml"

su -c "sed 's/port=\"8080\"/port=\"8085\"/g' /apache/softwares/apache8/apache-tomcat-8.5.4/conf/server.xml"
#su -c "sed -i '/<\/tomcat-users>/ i\<user username=\"msb\" password=\"msb\" roles=\"admin,manager-gui,manager-script,manager-status\"/>' >>  ./apache/softwares/apache8/apache-tomcat-8.5.4/conf/tomcat-users.xml"

#su -c "sudo /apache/softwares/apache8/apache-tomcat-8.5.4/bin/shutdown.sh" 

#su -c "/apache/softwares/apache8/apache-tomcat-8.5.4/bin/startup.sh" 
